...
def parse_date(value: Union[str, int, datetime, Tuple], **kwargs) -> datetime:
    ...
    if isinstance(value, int):
        ...
        parsed_value = datetime.strptime(value, **kwargs)
    ...
    if isinstance(value, Tuple):
        ...
        assert unit in [
            ...
            "hours",
            "weeks",
        ], f"Unsupported unit: {unit}. Supported units are days, seconds, microseconds, milliseconds, minutes, hours, weeks."
        assert isinstance(
            numeric_value, int
